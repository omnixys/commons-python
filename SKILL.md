...
# commons — Skill: Package Development

> Workflow for commons (packages/python/commons). Execute this workflow before, during, and
...
- Description: Omnixys shared platform contracts – transport-neutral DTOs, enums, errors, and models.
- Architecture: src/commons/ contracts (DTOs, enums, errors, models)
...
- This package is published (`omnixys-commons`); consumers pin versions and rely on SemVer.
